...
class DacceNFePHP extends CommonNFePHP implements DocumentoNFePHP
{
     ...
     */
    public function __construct($docXML = '', $sOrientacao = '', $sPapel = '', $sPathLogo = '', $sDestino = 'I', $aEnd = '', $creditos, $sDirPDF = '', $fontePDF = '', $mododebug = 2)
    {
    ...
    private function pHeader($x, $y, $pag)
    {
        ...
        $cpfDest = $this->aEnd['CPFDest'];
        $cnpjDest = $this->aEnd['CNPJDest'];
        ...
        if ($this->CNPJDest != '') {
            ...
            if($cnpjDest != '') {
                $texto = 'CNPJ do Destinatário: ' . $this->pFormat($cnpjDest, "##.###.###/####-##");
            }
        }
        ...
        if ($this->CPFDest != '') {
            ...
            if($cpfDest != '') {
                $texto = 'CPF do Destinatário: ' . $this->pFormat($cpfDest, "###.###.###-##");
            }
        }
