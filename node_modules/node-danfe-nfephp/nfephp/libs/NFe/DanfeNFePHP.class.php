...
class DanfeNFePHP extends CommonNFePHP implements DocumentoNFePHP
{
    ...
    */
    ...
    public function montaDANFE(
        ...
        if ($this->orientacao == 'P') {
            $this->pRodape($xInic, $y-1, $creditos);
        } else {
            $this->pRodape($xInic, $this->hPrint + 1, $creditos);
        }
        ...
        for ($n = 2; $n <= $totPag; $n++) {
            ...
            //coloca o rodapé da página
            if ($this->orientacao == 'P') {
                $this->pRodape($xInic, $y + 4, $creditos);
            } else {
                $this->pRodape($xInic, $this->hPrint + 4, $creditos);
            }
     ...
     * @return void
     */
    protected function pRodape($x, $y, $creditos)
    {
        if ($this->orientacao == 'P') {
              $w = $this->wPrint;
        } else {
        ...
        if($creditos == '') {
            $creditos = "DanfeNFePHP ver. " . $this->version .  "  Powered by NFePHP (GNU/GPLv3 GNU/LGPLv3) © www.nfephp.org";
        }

        $aFont = array('font'=>$this->fontePadrao, 'size'=>6, 'style'=>'I');
        $texto = "Impresso em ". date('d/m/Y') . " as " . date('H:i:s');
        $this->pTextBox($x, $y, $w, 0, $texto, $aFont, 'T', 'L', false);
        $this->pTextBox($x, $y, $w, 0, $creditos, $aFont, 'T', 'R', false);
    } //fim pRodape
