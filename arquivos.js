...
function loadXMLDoc() {
  ...
  filtro = [];// array do filtro

  sql = `SELECT id FROM nota_fiscal`; 
      ...
      $.ajax({
        ...
        success: function(response){
          ...
          if (filtro.indexOf(teste) === -1){
            ...
            db.run(`INSERT INTO nota_fiscal(id, versao, codigo_uf_emitente, codigo_chave_acesso, natureza_operacao, 
              forma_pagamento, modelo_documento_fiscal, serie_documento_fiscal, numero_documento_fiscal, data_hora_emissao, 
              data_hora_saida_entrada, tipo_operacao, codigo_municipio_fato_gerador, formato_impressao, tipo_emissao, digito_verificador_chave_acesso, 
              tipo_ambiente, finalidade_emissao_nf, indFinal, indPres, processo_emissao_nfe, versao_processo_emissao_nfe, cnpj_emitente, cpf_emitente, 
              razao_social_nome_emitente, nome_fantasia_emitente, logradouro_emitente, numero_emitente, complemento_emitente, bairro_emitente, codigo_municipio_emitente, 
              municipio_emitente, uf_sigla_emitente, codigo_cep_emitente, codigo_pais_emitente, pais_emitente, telefone_emitente, codigo_regime_tributario_emitente, 
              cnpj_destinatario, cpf_destinatario, razao_social_nome_destinatario, nome_fantasia_destinatario, logradouro_destinatario, numero_destinatario, 
              complemento_destinatario, bairro_destinatario, codigo_municipio_destinatario, municipio_destinatario, uf_sigla_destinatario, codigo_cep_destinatario, 
              codigo_pais_destinatario, pais_destinatario, telefone_destinatario, codigo_regime_tributario_destinatario, quantidade_itens, base_calculo_icms, 
              valor_total_icms, vICMSDeson, vFCPUFDest, vICMSUFDest, vICMSUFRemet, base_calculo_icmsst, valor_total_icmsst, valor_total_produtos_e_servicos, 
              valor_total_frete, valor_total_seguro, valor_total_desconto, valor_total_ii, valor_total_ipi, valor_total_pis, valor_total_cofins, valor_total_outros, 
              valor_total_nf, modalidade_frete, cnpj_transportador, cpf_transportador, razao_social_nome_transportador, inscricao_estadual_transportador, 
              endereco_completo_transportador, nome_municipio_transportador, uf_sigla_transportador, placa_veiculo_transportador, sigla_veiculo_transportador, 
              quantidade_volumes_transportados, especie_volumes, peso_liquido, peso_bruto, numero_fatura, valor_original, valor_liquido, numero_duplicata, data_vencimento, 
              valor_duplicata, informacoes_adicionais) 
              VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
            [
              array_db.id, 
              array_db.versao,
